$(function(){
	...
	$("#hanvos-navs").find("li").hover(function(){
		var $thisli = $(this).find('div.nav-child');
		...
		$thisli.addClass('nav-child subm');
		$thisi.addClass('arrow').addClass('a-nav');

	},function(){
		var $thislih = $(this).find('div.nav-child');
...
window.onscroll = function () {
	...
	var movepart = (top/(allh-realh))*400;
	//$(".adv-part").css("background-position-y",-140+movepart);
}